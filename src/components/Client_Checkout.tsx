                    ...
                    <div className="Checkout_Receive_Options">
                        ...
                        {receiveOption === "Entrega" && (
                            <>
                                ...
                                <div className="User_Order_Shipping_Info">
                                    ...
                                    <p>
                                        Para envios fora da cidade de Curitiba taxas adicionais serão cobradas - Após a finalização da compra
                                        entraremos em contato para lhe repassar o valor extra necessário e combinar uma data.
                                    </p>
                                </div>
                        ...
                        <div className="Recieve_Option_Observation">
                            ...
                            <textarea
                                ...
                                maxLength={512}
                                onChange={() => {
                                    const element = document.getElementById("receive_option_observation_text_area") as HTMLTextAreaElement;
